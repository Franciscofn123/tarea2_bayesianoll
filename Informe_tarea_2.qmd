...
plot(density(mcmc_samples3[[1]][,1]),ylim=c(0,80)
     ,xlim=c(0.39,0.55),main = "Densidades de P")
...
La siguiente tabla muestra las estimaciones de $\theta_t$ para cada modelo.
...
hacer comentariossssssssssssssssssssssssssssssssssss
...
Y ahora se tienen los intervalos de credibilidad de cada modelo.
